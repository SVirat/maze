$(function () {
    ...
    var BOARDREF = DB.collection('maze2').doc('board');
    var PLAYERSREF;
    ...
    var CURRENTSEED;
    var SIZE = 16;
    var BOARD_SIZE = Math.min(screen.height, screen.width) * 3/4; //used to be 600
    ...
    function monitorPlayers() {
      ...
      PLAYERSREF = DB.collection('maze2').doc('players' + CURRENTSEED);
